...
//api to get now playing movies from tbdb
  ...
  try {
    ...
    if (!movie) {
      ...
      const movieDetails = {
        ...
        original_language: movieApiData.original_language,tagline: movieApiData.tagline || '',
    ...
    await inngest.send({
      name: 'app/show.added',
      data: {movieId: movieId, movieTitle: movie.title}
    })
