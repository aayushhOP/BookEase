...
const MovieDetails = () => {
  ...
  return show ? (
    <div className='px-6 md:px-16 lg:px-40 pt-30 pt-30 md:pt-50'> 
        ...
        <div className='relative flex flex-col gap-3'>
         ...
         <BlurCircle top='-100px' left='-100px'/>
          ...
          <div className='flex items-center flex-wrap gap-4 mt-4'>
            ...
            <a className='px-10 py-3 text-sm bg-primary hover:bg-primary-dull transition rounded-md font-medium cursor-pointer' 
              href='#dateSelect'>
              Buy Tickets
            </a>
      ...
      <p className='text-lg font-medium mt-20'>Cast Details</p>
